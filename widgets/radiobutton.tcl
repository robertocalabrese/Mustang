...
# The radiobutton command creates a new window (given by the *window* argument) and makes it into a radiobutton widget.
# Additional options, described below, may be specified on the command line to configure aspects of the radiobutton.
# The radiobutton command returns the pathname of the new window.
#
...
#
# Note 2: The mustang radiobutton widget is a megawidget composed by an hull object (the megawidget container), a radiobutton
...
#### SYNOPSIS:
#
#   **radiobutton**  *window* ?*option* *value*? ... ?*option* *value*?
#
#### WIDGET OPTIONS:
#
...
#                                                           If there isn't one, the **-charwidth** of the **TRadiobutton** style
#                                                           will be used instead.
...
#
#                            If not provided, defaults to **TRadiobutton**.
#
...
#                                                           If there isn't one, the **-cursor** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-font** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-foreground** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-highlightcolor** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-image** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-indicatorbackground** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-indicatorforeground** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-indicatorrelief** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-justify** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-padding** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-spacer** of the **TRadiobutton** style
#                                                           will be used instead.
...
#                                                           If there isn't one, the **-wraplength** of the **TRadiobutton** style
#                                                           will be used instead.
...
#### WIDGET COMMAND:
#
# The radiobutton command creates a new command whose name is the same as the pathname of the radiobutton's window.
# This command may be used to invoke various operations on the widget.
# It has the following general form:
#
#   *window* *action* ?*arg* *arg* ... *arg*?
#
# *Window* is the name of the command, which is the same as the radiobutton widget pathname.
...
#     *Option* may be one of the widget options accepted by the radiobutton command (See **WIDGET OPTIONS**).
#
...
#### STATES:
#
# The radiobutton widget supports the **disabled** and **normal** state.
# The widget does not respond to user input if the disabled state is set.
# The widget sets the selected state whenever the linked **-variable** is set to the widget's **-value**, and clears it otherwise.
#
#### STYLING OPTIONS:
#
# Default style name: **TRadiobutton**
#
# Every radiobutton styleable option is supported and configurable with the [style](/wiki/commands/style.md) command.
...
#### BINDINGS:
#
# Mustang automatically creates several bindings for the radiobuttons in order to facilitate the developer work and augment the
# user experience at the same time.
#
# A **ContextMenu** binding is automatically set on every radiobutton.
# This binding is applied on every widget's objects so that the contextual menu of the radiobutton's toplevel will be executed
# everytime a **ContextMenu** event fires upon any of the radiobutton objects.
# If the toplevel has no contextual menu then nothing happens on the radiobutton when the event fires.
# If the developer needs a contextual menu on a radiobutton, one can be easily assigned with:
#
#    bind RADIOBUTTON <<ContextMenu>> [show CMENU %X %Y]
#
# Where:
#
#   'RADIOBUTTON' --> The hypothetical address of a radiobutton widget.
#   'CMENU'       --> The hypothetical address of the contextual menu.
#   'show'        --> The mustang command to display the contextual menu.
#   '%X and %Y'   --> The mouse pointer absolute coordinate at the time of the event.
#
# The above command will override all the **ContextMenu** bindings on the radiobutton objects.
#
###### SCROLLING
#
...
# parent with an active vertical or horizontal scrollbar and scroll that scrollbar.
#
...
#       machine program used (Parallels, VirtualBox, VMWare...), on the host machine and on the virtualized operating system in use.
#
# 1.  **ButtonPress-1**, **Return** and **space** will select the radiobutton and invoke the associated command.
#
# 2.  The **Tab** key will change the focus to the next focussable widget while **Shift-Tab** key will change it to the
...
#### EXAMPLE:
#
#   # Create 3 radiobuttons linked together by the same variable.
#   set ::MyVar 1
#
#   radiobutton .radio1   -command { chan puts ".radio1 was invoked, result --> $::MyVar" } \
#                           -state normal \
#                           -style TRadiobutton \
#                       -takefocus 1 \
#                            -text "Radiobutton 1" \
...
#                        -variable ::MyVar;
#
#   radiobutton .radio2   -command { chan puts ".radio2 was invoked, result --> $::MyVar" } \
#                           -state normal \
#                           -style TRadiobutton \
#                       -takefocus 1 \
#                            -text "Radiobutton 2" \
...
#                        -variable ::MyVar;
#
#   radiobutton .radio3   -command { chan puts ".radio3 was invoked, result --> $::MyVar" } \
#                           -state normal \
#                           -style TRadiobutton \
#                       -takefocus 1 \
#                            -text "Radiobutton 3" \
...
# Destroy
_bind _Hull_Radiobutton <Destroy> { ::ms::radiobutton::Destroy %W; break }

# Enter/Leave
_bind _Hull_Radiobutton <Enter> { ::ms::Hover %W %X %Y; break }
_bind _Hull_Radiobutton <Leave> { ::ms::Hover %W %X %Y; break }
...
# and move that scrollbar by one unit up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Hull_Radiobutton <MouseWheel> { ::ms::Scroll_Parent_Y %W %D units; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one unit left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Hull_Radiobutton <Shift-MouseWheel> { ::ms::Scroll_Parent_X %W %D units; break }

# Try to find the innermost widget's scrollable parent with an active vertical scrollbar
# and move that scrollbar by one page up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Hull_Radiobutton <Control-MouseWheel> { ::ms::Scroll_Parent_Y %W %D pages; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one page left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Hull_Radiobutton <Control-Shift-MouseWheel> { ::ms::Scroll_Parent_X %W %D pages; break }
...
#       and move that scrollbar by one unit up or down (depending on the touchpad direction).
#       If none of the widget's parent meets the required condition, don't do anything on the vertical axis.
_bind _Hull_Radiobutton <TouchpadScroll> { ::ms::Touchpad_Parent %W %# %D units; break }
...
#       and move that scrollbar by one page up or down (depending on the touchpad direction).
#       If none of the widget's parent meets the required condition, don't do anything on the vertical axis.
_bind _Hull_Radiobutton <Control-TouchpadScroll> { ::ms::Touchpad_Parent %W %# %D pages; break }

#############################################
##                                         ##
##     _INDICATOR_RADIOBUTTON BINDINGS     ##
##                                         ##
#############################################
...
# FocusIn/FocusOut
_bind _Indicator_Radiobutton <FocusIn>  { ::ms::radiobutton::Pathname_Cmd [_winfo parent %W] state focus; break }
...
switch -- [_tk windowingsystem] {
    ...
    default {
        ...
        try {
            _bind _Indicator_Radiobutton <hpBackTab>   { ::tk::TabToWindow [tk_focusPrev [_winfo parent %W]]; break }
        } on error {} {
            # Do nothing.
        }
    }
...
# and move that scrollbar by one unit up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Indicator_Radiobutton <MouseWheel> { ::ms::Scroll_Parent_Y [_winfo parent %W] %D units; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one unit left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Indicator_Radiobutton <Shift-MouseWheel> { ::ms::Scroll_Parent_X [_winfo parent %W] %D units; break }

# Try to find the innermost widget's scrollable parent with an active vertical scrollbar
# and move that scrollbar by one page up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Indicator_Radiobutton <Control-MouseWheel> { ::ms::Scroll_Parent_Y [_winfo parent %W] %D pages; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one page left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Indicator_Radiobutton <Control-Shift-MouseWheel> { ::ms::Scroll_Parent_X [_winfo parent %W] %D pages; break }
...
#       and move that scrollbar by one unit up or down (depending on the touchpad direction).
#       If none of the widget's parent meets the required condition, don't do anything on the vertical axis.
_bind _Indicator_Radiobutton <TouchpadScroll> { ::ms::Touchpad_Parent [_winfo parent %W] %# %D units; break }
...
#       and move that scrollbar by one page up or down (depending on the touchpad direction).
#       If none of the widget's parent meets the required condition, don't do anything on the vertical axis.
_bind _Indicator_Radiobutton <Control-TouchpadScroll> { ::ms::Touchpad_Parent [_winfo parent %W] %# %D pages; break }

#########################################
##                                     ##
##     _LABEL_RADIOBUTTON BINDINGS     ##
##                                     ##
#########################################
...
# and move that scrollbar by one unit up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Label_Radiobutton <MouseWheel> { ::ms::Scroll_Parent_Y [_winfo parent %W] %D units; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one unit left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Label_Radiobutton <Shift-MouseWheel> { ::ms::Scroll_Parent_X [_winfo parent %W] %D units; break }

# Try to find the innermost widget's scrollable parent with an active vertical scrollbar
# and move that scrollbar by one page up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Label_Radiobutton <Control-MouseWheel> { ::ms::Scroll_Parent_Y [_winfo parent %W] %D pages; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one page left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Label_Radiobutton <Control-Shift-MouseWheel> { ::ms::Scroll_Parent_X [_winfo parent %W] %D pages; break }
...
#       and move that scrollbar by one unit up or down (depending on the touchpad direction).
#       If none of the widget's parent meets the required condition, don't do anything on the vertical axis.
_bind _Label_Radiobutton <TouchpadScroll> { ::ms::Touchpad_Parent [_winfo parent %W] %# %D units; break }
...
proc ::ms::radiobutton::Command { window { args "" } } {
    ...
    switch -- [expr { [llength $args]%2 }] {
        0   {
            ...
            _bindtags $w [list $w _Hull_Radiobutton TFrame $::ms::addr($w,toplevel) all]

            # Set the new bindtags for the widget container ('w').
            switch -- $::ms::current($w,class) {
                TRadiobutton { _bindtags $w.indicator [list $w.indicator _Indicator_Radiobutton TRadiobutton $::ms::addr($w,toplevel) all] }
                default      { _bindtags $w.indicator [list $w.indicator $::ms::current($w,class) _Indicator_Radiobutton TRadiobutton $::ms::addr($w,toplevel) all] }
            }

            # Set the new bindtags for the label object.
            _bindtags $w.label [list $w.label _Label_Radiobutton TLabel $::ms::addr($w,toplevel) all]

            # Set the new bindtags for the highlight object.
            _bindtags $w.highlight [list $w.highlight _Highlight_Radiobutton TFrame $::ms::addr($w,toplevel) all]
...
#
# It doesn't return anything.
proc ::ms::radiobutton::ButtonPress { w } {
    # Check the widget's state.
    switch -- $::ms::current($w,state) {
        disabled { return "" }
    }
    ...
    switch -- [$w.indicator instate [list focus]] {
        0   {
            ...
            ::ms::radiobutton::Pathname_Cmd $w state [list focus]
        }
    }
...
#
# It doesn't return anything.
proc ::ms::radiobutton::FocusOut { w } {
