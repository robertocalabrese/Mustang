...
#### DESCRIPTION:
#
# A toolbutton widget displays a textual button and/or image, and evaluates a command when pressed.
# Toolbuttons works in a slighty different way than buttons; depending their initial state (*pressed* or *!pressed*),
# **ButtonRelease-1** events on toolbuttons will invert their state (from *pressed* to *!pressed* and viceversa) while
# **ButtonRelease-1** events on buttons will change their state back to *!pressed*.
# In both cases the **ButtonRelease-1** events will invoke the command associated with the widget, if any.
# This is useful for creating widgets for toolbars.
#
# The toolbutton command creates a new window (given by the *window* argument) and makes it into a toolbutton widget.
# Additional options, described below, may be specified on the command line to configure aspects of the toolbutton.
# The toolbutton command returns the pathname of the new window.
#
...
#### SYNOPSIS:
#
#   **toolbutton**  *window* ?*option* *value*? ... ?*option* *value*?
#
#### WIDGET OPTIONS:
#
...
#                                                    If there isn't one, the **-anchor** of the **Toolbutton** style
...
#                                                    If there isn't one, the **-background** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-bordercolor** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-borderwidth** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-charwidth** of the **Toolbutton** style
#                                                    will be used instead.
...
#
#                     If not provided, defaults to **Toolbutton**.
#
...
#                                                    If there isn't one, the **-compound** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-cursor** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-darkcolor** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-font** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-foreground** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-image** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-justify** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-lightcolor** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-padding** of the **Toolbutton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-relief** of the **Toolbutton** style
#                                                    will be used instead.
#                                                    The '*-relief*' will always abide by its mapping values, if any.
#                                                    Styles, mappings and states events are allowed to change its value.
#
#                     See also **-bordercolor** and **-borderwidth**.
#
# **-shiftrelief**    Specifies an integer indicating how far the toolbutton contents are shifted down
#                     and right in the pressed state. This action provides additional skeuomorphic feedback.
#
#                     Note: It's only meaningful if the current theme don't use the 'clam' engine (like the 'Halo' theme).
#
#                     Note: This is a styleable option.
#
#                           If it's provided     --> Styles, mappings and states events cannot change its value.
#                                                    Only the developer can.
#
#                           If it's not provided --> The widget will follow the **-shiftrelief** specified in its style.
#                                                    If there isn't one, the **-shiftrelief** of the **Toolbutton** style
#                                                    will be used instead.
#                                                    The '*-shiftrelief*' will not abide by its mapping values, if any.
#                                                    It is not supposed to change when the widget 'dynamic' state changes.
#
# **-state**          Specifies the 'physical' state for the widget.
#                     Changes to the widget's 'physical' state does not affects the widget's 'dynamic' state.
...
#### WIDGET COMMAND:
#
# The toolbutton command creates a new command whose name is the same as the pathname of the toolbutton's window.
# This command may be used to invoke various operations on the widget.
# It has the following general form:
#
#   *window* *action* ?*arg* *arg* ... *arg*?
#
# *Window* is the name of the command, which is the same as the toolbutton widget pathname.
# *Actions* and the *arg*s determine the exact behavior of the *window* command.
#
# The following commands are possible for toolbutton widgets:
#
#   *window* **cget** ?*option*?
#     Returns the current value of the option given by *option*.
#     *Option* may be one of the widget options accepted by the toolbutton command (See **WIDGET OPTIONS**).
#
...
#
#   *window* **invoke**
#     Invokes the command associated with the toolbutton.
...
#### STATES:
#
# The toolbutton widget supports the **disabled** and **normal** state.
#
#### STYLING OPTIONS:
#
# Default style name: **Toolbutton**
#
# Every toolbutton styleable option is supported and configurable with the [style](/wiki/commands/style.md) command.
...
#### BINDINGS:
#
# Mustang automatically creates several bindings for the toolbuttons in order to facilitate the developer work and
...
#     Note that differently than the button widget,
#
...
#
# 3.  **Shift-MouseWheel** events will try to find the innermost widget's scrollable parent with an active horizontal
#     scrollbar and move that scrollbar by one unit left or right (depending on the mousewheel direction).
#     If none of the widget's parents meets the required condition, nothing will happen.
#
# 4.  **Control-MouseWheel** events will try to find the innermost widget's scrollable parent with an active vertical
#     scrollbar and move that scrollbar by one page up or down (depending on the mousewheel direction).
#     If none of the widget's parents meets the required condition, nothing will happen.
#
# 5.  **Control-Shift-MouseWheel** events will try to find the innermost widget's scrollable parent with an active
#     horizontal scrollbar and move that scrollbar by one page left or right (depending on the mousewheel direction).
#     If none of the widget's parents meets the required condition, nothing will happen.
#
# 6.  **TouchpadScroll** events may happen on two different planes, horizontal and vertical.
...
#
# 7.  **Control-TouchpadScroll** events may happen on two different planes, horizontal and vertical.
#     These two planes may involve different widgets depending on the active scrollbars on them and on the touchpad
#     direction.
#
...
#     focussable widget.
#
# There are other bindings in place for internal mechanism like **Activate/Deactivate** and **Destroy**.
#
...
#### EXAMPLE:
#
#   # Set the toolbutton variables.
#   set ::toolbutton1 1
#   set ::toolbutton2 0
#   set ::toolbutton3 1
#
#   # Create a label.
#   toolbutton .tb1 -charwidth 10 \
#                     -command [list ::Invoke "3" "::toolbutton1"] \
#                    -compound none \
#                      -cursor hand \
#                       -state normal \
#                       -style Toolbutton \
...
#                        -text "Button 1" \
#                   -underline -1 \
#                    -variable ::toolbutton1;
#
#   toolbutton .tb2 -charwidth 10 \
#                     -command [list ::Invoke "3" "::toolbutton2"] \
#                    -compound none \
#                      -cursor hand \
#                       -state normal \
#                       -style Toolbutton \
...
#                        -text "Button 2" \
#                   -underline -1 \
#                    -variable ::toolbutton2;
#
#   toolbutton .tb3 -charwidth 10 \
#                     -command [list ::Invoke "3" "::toolbutton3"] \
#                    -compound none \
#                      -cursor hand \
#                       -state normal \
#                       -style Toolbutton \
...
#
#   proc ::Invoke { n var } {
#       chan puts "You invoked Toolbutton $n. The new value is '[set $var]'"
#   }
#
...
#   }
package provide ::ms::toolbutton 0.1

##################################
##                              ##
##     _TOOLBUTTON BINDINGS     ##
##                              ##
##################################
...
_bind _Toolbutton <MouseWheel> { ::ms::Scroll_Parent_Y %W %D units; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one unit left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Toolbutton <Shift-MouseWheel> { ::ms::Scroll_Parent_X %W %D units; break }

# Try to find the innermost widget's scrollable parent with an active vertical scrollbar
# and move that scrollbar by one page up or down (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Toolbutton <Control-MouseWheel> { ::ms::Scroll_Parent_Y %W %D pages; break }

# Try to find the innermost widget's scrollable parent with an active horizontal scrollbar
# and move that scrollbar by one page left or right (depending on the mousewheel direction).
# If none of the widget's parent meets the required condition, don't do anything.
_bind _Toolbutton <Control-Shift-MouseWheel> { ::ms::Scroll_Parent_X %W %D pages; break }
...
_bind _Toolbutton <TouchpadScroll> { ::ms::Touchpad_Parent %W %# %D units; break }
...
## Command
#
# Create the **toolbutton** widget command.
#
# Where:
#
...
proc ::ms::toolbutton::Command { window { args "" } } {
    ...
    switch -- [expr { [llength $args]%2 }] {
        0   {
            ...
            set ::ms::default($w,class)        $::ms::default(toolbutton,class)
            set ::ms::default($w,cmenu)        $::ms::default(toolbutton,cmenu)
            set ::ms::default($w,command)      $::ms::default(toolbutton,command)
            set ::ms::default($w,offvalue)     $::ms::default(toolbutton,offvalue)
            set ::ms::default($w,onvalue)      $::ms::default(toolbutton,onvalue)
            set ::ms::default($w,state)        $::ms::default(toolbutton,state)
            set ::ms::default($w,style)        $::ms::default(toolbutton,style)
            set ::ms::default($w,takefocus)    $::ms::default(toolbutton,takefocus)
            set ::ms::default($w,text)         $::ms::default(toolbutton,text)
            set ::ms::default($w,textvariable) $::ms::default(toolbutton,textvariable)
            set ::ms::default($w,underline)    $::ms::default(toolbutton,underline)
            set ::ms::default($w,variable)     $::ms::default(toolbutton,variable)

            # Set the current widget (not styleable) options.
            set ::ms::current($w,class)        $::ms::default(toolbutton,class)
            set ::ms::current($w,cmenu)        $::ms::default(toolbutton,cmenu)
            set ::ms::current($w,command)      $::ms::default(toolbutton,command)
            set ::ms::current($w,offvalue)     $::ms::default(toolbutton,offvalue)
            set ::ms::current($w,onvalue)      $::ms::default(toolbutton,onvalue)
            set ::ms::current($w,state)        $::ms::default(toolbutton,state)
            set ::ms::current($w,style)        $::ms::default(toolbutton,style)
            set ::ms::current($w,takefocus)    $::ms::default(toolbutton,takefocus)
            set ::ms::current($w,text)         $::ms::default(toolbutton,text)
            set ::ms::current($w,textvariable) $::ms::default(toolbutton,textvariable)
            set ::ms::current($w,underline)    $::ms::default(toolbutton,underline)
            set ::ms::current($w,variable)     $::ms::default(toolbutton,variable)

            # Set the widget variable needed for internal mechanisms.
            set ::ms::data($w,classtype) toolbutton
            ...
            #
            #       To make a toolbutton styleable option managed by the developer, just set your desired value
            #       for that option through the create or configure command, like:
            #
            #           **toolbutton** *window* **-background** red
            #       or
                ...
                switch -nocase -- $option {
                    ...
                    -style {
                        if { $value in $::ms::style($::ms::theme) } {
                            ...
                            # If not, create one by mirroring the current theme 'Toolbutton' layout.
                            if { $value ni $::ms::layouts($::ms::theme) } {
                                _ttk_style layout $value [_ttk_style layout Toolbutton]
                            }
            ...
            switch -- $::ms::current($w,class) {
                Toolbutton { _bindtags $w [list $w _Toolbutton TButton $::ms::addr($w,toplevel) all] }
                default    { _bindtags $w [list $w $::ms::current($w,class) _Toolbutton TButton $::ms::addr($w,toplevel) all] }
            }
            ...
            lappend ::ms::data($w,token) [interp alias {} $w {} ::ms::toolbutton::Pathname_Cmd $w]

            # If needed, create an alias for the widget short address pathcommand.
            if { $short_addr ne $w } {
                lappend ::ms::data($w,token) [interp alias {} $short_addr {} ::ms::toolbutton::Pathname_Cmd $w]
            }
            ...
            # Add the widget address to the toolbutton widgets real address list.
            lappend ::ms::addr(toolbutton) $w

            # Add the widget address to the toolbutton classtype real address list with class '::ms::current($w,class)'.
            lappend ::ms::class($::ms::current($w,class),toolbutton,addrs) $w

            # Add the widget address to the toolbutton classtype real address list with style '::ms::current($w,style)'.
            lappend ::ms::style($::ms::current($w,style),toolbutton,addrs) $w

            # If needed, add '::ms::current($w,style)' to the available styles for the toolbutton classtype.
            if { $::ms::current($w,style) ni $::ms::style(toolbutton,classtype) } {
                lappend ::ms::style(toolbutton,classtype) $::ms::current($w,style)
            }
...
proc ::ms::toolbutton::Pathname_Cmd { w cmd args } {
    # Get the caller information.
    set caller_info [info frame -1]
        ...
        configure {
            ...
            switch -- [llength $args] {
                0   {
                    ...
                    foreach option $::ms::toolbutton(non_styleable,options) {
                                ...
                                switch -nocase -- $option {
                                    ...
                                    -style {
                                        if { $value in $::ms::style($::ms::theme) } {
                                            ...
                                            # Remove the widget address from the toolbutton classtype real address list that contains all the
                                            ...
                                            # If needed, add 'value' to the available styles for the toolbutton classtype.
                                            if { $value ni $::ms::style(toolbutton,classtype) } {
                                                lappend ::ms::style(toolbutton,classtype) $value
                                            }
...
## Style_Update
#
# Update any toolbutton widget that have stylename as its style.
#
# Where:
#
...
#
# It doesn't return anything.
proc ::ms::toolbutton::ButtonPress { w } {
