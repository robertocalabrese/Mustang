...
#### DESCRIPTION:
#
# A button widget displays a textual button and/or image, and evaluates a command when pressed.
# The button command creates a new window (given by the *window* argument) and makes it into a button widget.
# Additional options, described below, may be specified on the command line to configure aspects of the button.
# The button command returns the pathname of the new window.
#
...
#### SYNOPSIS:
#
#   **button**  *window* ?*option* *value*? ... ?*option* *value*?
#
#### WIDGET OPTIONS:
#
...
#                                                    If there isn't one, the **-background** of the **TButton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-bordercolor** of the **TButton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-darkcolor** of the **TButton** style
#                                                    will be used instead.
...
#                     In a dialog box, one button may be designated to be the *default* button (meaning, roughly, "the one
#                     that gets invoked when the user presses <Enter>").
#
#                     **Active** indicates that this is currently the default button, **normal** means that it may become
#                     the default button, and **disabled** means that it is not defaultable.
#
...
#                                                    If there isn't one, the **-foreground** of the **TButton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-image** of the **TButton** style
#                                                    will be used instead.
...
#                                                    If there isn't one, the **-lightcolor** of the **TButton** style
#                                                    will be used instead.
...
#
# **-shiftrelief**    Specifies an integer indicating how far the button contents are shifted down
...
#### WIDGET COMMAND:
#
# The button command creates a new command whose name is the same as the pathname of the button's window.
...
#### STATES:
#
# The button widget supports the **disabled** and **normal** state.
#
#### STYLING OPTIONS:
#
# Default style name: **TButton**
#
# Every button styleable option is supported and configurable with the [style](/wiki/commands/style.md) command.
...
#### BINDINGS:
#
# Mustang automatically creates several bindings for the buttons in order to facilitate the developer work and
...
#
#   # Create a label.
#   button .b1 -charwidth 10 \
#                -command [list ::Invoke "1"] \
#               -compound none \
#                 -cursor hand \
#                -default active \
#                  -state normal \
...
#              -underline -1;
#
#   button .b2 -charwidth 10 \
#                -command [list ::Invoke "2"] \
#               -compound none \
#                 -cursor hand \
#                -default normal \
#                  -state normal \
...
#              -underline -1;
#
#   button .b3 -charwidth 10 \
#                -command [list ::Invoke "3"] \
#               -compound none \
#                 -cursor hand \
#                -default normal \
#                  -state normal \
...
#
#   proc ::Invoke { n } {
#       chan puts "You invoked Button $n."
#   }
#
        ...
        identify {
            ...
            switch -- [llength $args] {
                3   {
                    ...
                    # Return the name of the object, or an empty string if there are no button objects at the coordinates provided.
                    if { $widget eq $w } {
                        return "Button"
                    } else {
                        return ""
