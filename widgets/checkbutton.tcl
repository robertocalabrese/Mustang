...
#############################################
##                                         ##
##     _HIGHLIGHT_CHECKBUTTON BINDINGS     ##
##                                         ##
#############################################
...
# Destroy
_bind _Hull_Checkbutton <Destroy> { ::ms::checkbutton::Destroy %W; break }
...
#############################################
##                                         ##
##     _INDICATOR_CHECKBUTTON BINDINGS     ##
##                                         ##
#############################################
...
proc ::ms::checkbutton::Command { window { args "" } } {
    ...
    switch -- [expr { [llength $args]%2 }] {
        0   {
            ...
            _bindtags $w.label [list $w.label _Label_Checkbutton TLabel $::ms::addr($w,toplevel) all]

            # Set the new bindtags for the highlight object.
            _bindtags $w.highlight [list $w.highlight _Highlight_Checkbutton TFrame $::ms::addr($w,toplevel) all]
...
## ButtonPress
#
# Select the checkbutton where the <ButtonPress-1> event happened.
#
# Where:
#
# w   Should be the widget real address involved.
