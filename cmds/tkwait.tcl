...
namespace eval ::ms::tkwait {}

# Rename the original Tk **tkwait** command.
rename tkwait _tkwait

# Create an alias for the mustang **tkwait** command.
interp alias {} tkwait {} ::ms::tkwait::Command

## Command
#
# Replace the Tk **tkwait** command.
#
# Where:
#
# args   Should be the arguments of the **tkwait** command.
#
