...
package provide ::ms::image 0.1

# Create the mustang **image** package.
namespace eval ::ms::image {}

# Rename the original Tk **image** command.
rename image _image

# Create an alias for the mustang **image** command.
interp alias {} image {} ::ms::image::Command

## Command
#
# Replace the Tk **image** command.
#
# Where:
#
# args   Should be the arguments of the **image** command.
#
# Depending on the *action* provided, the return value/s may vary.
proc ::ms::image::Command { args } {
