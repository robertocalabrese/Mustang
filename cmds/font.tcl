...
package provide ::ms::font 0.1

# Create the mustang **font** package.
namespace eval ::ms::font {}

# Rename the original Tk **font** command.
rename font _font

# Create an alias for the mustang **font** command.
interp alias {} font {} ::ms::font::Command

## Command
#
# Replace the Tk **font** command.
#
# Where:
#
# args   Should be the arguments of the **font** command.
#
# Depending on the *action* provided, the return value/s may vary.
proc ::ms::font::Command { args } {
