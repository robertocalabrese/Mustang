...
namespace eval ::ms::destroy {}

# Rename the original Tk **destroy** command.
rename destroy _destroy

# Create an alias for the mustang **destroy** command.
interp alias {} destroy {} ::ms::destroy::Command

## Command
#
# Replace the Tk **destroy** command.
#
# Where:
#
# args   Should be the arguments of the **destroy** command.
#
