...
namespace eval ::ms::raise {}

# Rename the original Tk **raise** command.
rename raise _raise

# Create an alias for the mustang **raise** command.
interp alias {} raise {} ::ms::raise::Command

## Command
#
# Replace the Tk **raise** command.
#
# Where:
#
# args   Should be the arguments of the **raise** command.
#
