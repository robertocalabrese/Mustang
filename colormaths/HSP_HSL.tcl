...
package provide ::ms::HSP_HSL 0.1

# Create the mustang **HSP_HSL** package.
namespace eval ::ms::HSP_HSL {}

# Create an alias for the mustang **HSP_HSL** conversion command.
interp alias {} ::HSP_HSL {} ::ms::HSP_HSL::Conversion

## Conversion
#
# Transform **HSP** colors into **HSL** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSP_HSL::Conversion { channels } {
