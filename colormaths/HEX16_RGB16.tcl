...
package provide ::ms::HEX16_RGB16 0.1

# Create the mustang **HEX16_RGB16** package.
namespace eval ::ms::HEX16_RGB16 {}

# Create an alias for the mustang **HEX16_RGB16** conversion command.
interp alias {} ::HEX16_RGB16 {} ::ms::HEX16_RGB16::Conversion

## Conversion
#
# Transform **HEX16** colors into **RGB16** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HEX16_RGB16::Conversion { hexadecimals } {
