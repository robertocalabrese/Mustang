...
package provide ::ms::RGB8_rgb 0.1

# Create the mustang **RGB8_rgb** package.
namespace eval ::ms::RGB8_rgb {}

# Create an alias for the mustang **RGB8_rgb** conversion command.
interp alias {} ::RGB8_rgb {} ::ms::RGB8_rgb::Conversion

## Conversion
#
# Transform **RGB8** colors into **rgb** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::RGB8_rgb::Conversion { channels } {
