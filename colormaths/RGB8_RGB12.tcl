...
package provide ::ms::RGB8_RGB12 0.1

# Create the mustang **RGB8_RGB12** package.
namespace eval ::ms::RGB8_RGB12 {}

# Create an alias for the mustang **RGB8_RGB12** conversion command.
interp alias {} ::RGB8_RGB12 {} ::ms::RGB8_RGB12::Conversion

## Conversion
#
# Transform **RGB8** colors into **RGB12** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::RGB8_RGB12::Conversion { channels } {
