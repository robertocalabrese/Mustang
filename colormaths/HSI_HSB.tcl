...
package provide ::ms::HSI_HSB 0.1

# Create the mustang **HSI_HSB** package.
namespace eval ::ms::HSI_HSB {}

# Create an alias for the mustang **HSI_HSB** conversion command.
interp alias {} ::HSI_HSB {} ::ms::HSI_HSB::Conversion

## Conversion
#
# Transform **HSI** colors into **HSB** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSI_HSB::Conversion { channels } {
