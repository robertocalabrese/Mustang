...
package provide ::ms::RGB16_RGB8 0.1

# Create the mustang **RGB16_RGB8** package.
namespace eval ::ms::RGB16_RGB8 {}

# Create an alias for the mustang **RGB16_RGB8** conversion command.
interp alias {} ::RGB16_RGB8 {} ::ms::RGB16_RGB8::Conversion

## Conversion
#
# Transform **RGB16** colors into **RGB8** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::RGB16_RGB8::Conversion { channels } {
