...
package provide ::ms::HEX8_RGB8 0.1

# Create the mustang **HEX8_RGB8** package.
namespace eval ::ms::HEX8_RGB8 {}

# Create an alias for the mustang **HEX8_RGB8** conversion command.
interp alias {} ::HEX8_RGB8 {} ::ms::HEX8_RGB8::Conversion

## Conversion
#
# Transform **HEX8** colors into **RGB8** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HEX8_RGB8::Conversion { hexadecimals } {
