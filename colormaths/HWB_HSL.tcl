...
package provide ::ms::HWB_HSL 0.1

# Create the mustang **HWB_HSL** package.
namespace eval ::ms::HWB_HSL {}

# Create an alias for the mustang **HWB_HSL** conversion command.
interp alias {} ::HWB_HSL {} ::ms::HWB_HSL::Conversion

## Conversion
#
# Transform **HWB** colors into **HSL** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HWB_HSL::Conversion { channels } {
