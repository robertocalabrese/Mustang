...
package provide ::ms::HSP_HSI 0.1

# Create the mustang **HSP_HSI** package.
namespace eval ::ms::HSP_HSI {}

# Create an alias for the mustang **HSP_HSI** conversion command.
interp alias {} ::HSP_HSI {} ::ms::HSP_HSI::Conversion

## Conversion
#
# Transform **HSP** colors into **HSI** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSP_HSI::Conversion { channels } {
