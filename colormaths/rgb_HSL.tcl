...
package provide ::ms::rgb_HSL 0.1

# Create the mustang **rgb_HSL** package.
namespace eval ::ms::rgb_HSL {}

# Create an alias for the mustang **rgb_HSL** conversion command.
interp alias {} ::rgb_HSL {} ::ms::rgb_HSL::Conversion

## Conversion
#
# Transform **rgb** colors into **HSL** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::rgb_HSL::Conversion { channels } {
