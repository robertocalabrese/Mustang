...
package provide ::ms::HSL_HSI 0.1

# Create the mustang **HSL_HSI** package.
namespace eval ::ms::HSL_HSI {}

# Create an alias for the mustang **HSL_HSI** conversion command.
interp alias {} ::HSL_HSI {} ::ms::HSL_HSI::Conversion

## Conversion
#
# Transform **HSL** colors into **HSI** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSL_HSI::Conversion { channels } {
