...
package provide ::ms::HEX12_RGB12 0.1

# Create the mustang **HEX12_RGB12** package.
namespace eval ::ms::HEX12_RGB12 {}

# Create an alias for the mustang **HEX12_RGB12** conversion command.
interp alias {} ::HEX12_RGB12 {} ::ms::HEX12_RGB12::Conversion

## Conversion
#
# Transform **HEX12** colors into **RGB12** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HEX12_RGB12::Conversion { hexadecimals } {
