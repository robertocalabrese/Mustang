...
package provide ::ms::HSL_HSP 0.1

# Create the mustang **HSL_HSP** package.
namespace eval ::ms::HSL_HSP {}

# Create an alias for the mustang *HSL_HSP* conversion command.
interp alias {} ::HSL_HSP {} ::ms::HSL_HSP::Conversion

## Conversion
#
# Transform **HSL** colors into **HSP** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSL_HSP::Conversion { channels } {
