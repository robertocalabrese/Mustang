...
package provide ::ms::HSB_HSP 0.1

# Create the mustang **HSB_HSP** package.
namespace eval ::ms::HSB_HSP {}

# Create an alias for the mustang **HSB_HSP** conversion command.
interp alias {} ::HSB_HSP {} ::ms::HSB_HSP::Conversion

## Conversion
#
# Transform **HSB** colors into **HSP** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSB_HSP::Conversion { channels } {
