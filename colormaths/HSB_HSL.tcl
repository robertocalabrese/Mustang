...
package provide ::ms::HSB_HSL 0.1

# Create the mustang **HSB_HSL** package.
namespace eval ::ms::HSB_HSL {}

# Create an alias for the mustang **HSB_HSL** conversion command.
interp alias {} ::HSB_HSL {} ::ms::HSB_HSL::Conversion

## Conversion
#
# Transform **HSB** colors into **HSL** colors.
#
# Where:
#
...
proc ::ms::HSB_HSL::Conversion { channels } {
