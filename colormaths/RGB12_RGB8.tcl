...
package provide ::ms::RGB12_RGB8 0.1

# Create the mustang **RGB12_RGB8** package.
namespace eval ::ms::RGB12_RGB8 {}

# Create an alias for the mustang **RGB12_RGB8** conversion command.
interp alias {} ::RGB12_RGB8 {} ::ms::RGB12_RGB8::Conversion

## Conversion
#
# Transform **RGB12** colors into **RGB8** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::RGB12_RGB8::Conversion { channels } {
