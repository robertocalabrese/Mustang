...
package provide ::ms::HSI_HSP 0.1

# Create the mustang **HSI_HSP** package.
namespace eval ::ms::HSI_HSP {}

# Create an alias for the mustang **HSI_HSP** conversion command.
interp alias {} ::HSI_HSP {} ::ms::HSI_HSP::Conversion

## Conversion
#
# Transform **HSI** colors into **HSP** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSI_HSP::Conversion { channels } {
