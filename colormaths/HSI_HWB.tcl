...
package provide ::ms::HSI_HWB 0.1

# Create the mustang **HSI_HWB** package.
namespace eval ::ms::HSI_HWB {}

# Create an alias for the mustang **HSI_HWB** conversion command.
interp alias {} ::HSI_HWB {} ::ms::HSI_HWB::Conversion

## Conversion
#
# Transform **HSI** colors into **HWB** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSI_HWB::Conversion { channels } {
    foreach { hue saturation intensity } $channels {
        # Check if it's a gray.
        switch -nocase -- $hue {
            UNDEF {
                set blackness [expr { 100.0-$intensity }]

                # It's a gray.
                lappend results UNDEF $intensity $blackness
            }
            default {
