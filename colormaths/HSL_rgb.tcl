...
package provide ::ms::HSL_rgb 0.1

# Create the mustang **HSL_rgb** package.
namespace eval ::ms::HSL_rgb {}

# Create an alias for the mustang **HSL_rgb** conversion command.
interp alias {} ::HSL_rgb {} ::ms::HSL_rgb::Conversion

## Conversion
#
# Transform **HSL** colors into **rgb** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::HSL_rgb::Conversion { channels } {
