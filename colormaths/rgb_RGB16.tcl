...
package provide ::ms::rgb_RGB16 0.1

# Create the mustang **rgb_RGB16** package.
namespace eval ::ms::rgb_RGB16 {}

# Create an alias for the mustang **rgb_RGB16** conversion command.
interp alias {} ::rgb_RGB16 {} ::ms::rgb_RGB16::Conversion

## Conversion
#
# Transform **rgb** colors into **RGB16** colors.
#
# Where:
#
...
#
#   and so on and so forth...
proc ::ms::rgb_RGB16::Conversion { channels } {
